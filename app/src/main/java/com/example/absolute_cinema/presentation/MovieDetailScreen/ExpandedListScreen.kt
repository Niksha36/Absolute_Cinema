...
fun ExpandedListScreen(
    ...
    Scaffold(
        ...
        Box(
                        ...
                        ExpandedListContentTypes.COMMENTS -> {
                            ...
                            CommentCard(
                                ...
                                modifier =  Modifier
                                    .fillMaxWidth()
                                    .height(300.dp),
                                toggleShowExpandedContent = { onItemClick(comment) }
                            )
                        }
            ...
            if (purpose== ExpandedListContentTypes.SINGLE_COMMENT) {
                val comment = listOfItems.first() as MovieComment
                FullScreenComment(comment = comment)
            }
        }
    }
}
